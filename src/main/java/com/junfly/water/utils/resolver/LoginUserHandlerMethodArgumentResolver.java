package com.junfly.water.utils.resolver;
...
import com.junfly.water.utils.annotation.LoginUser;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户ID
        Object object = request.getAttribute(Global.LOGIN_USER_KEY, RequestAttributes.SCOPE_REQUEST);
        if(object == null){
            return null;
        }
